    ...
    this.$rules = { start: 
       [ { token: 
         ...
         { token: 'keyword.auth_anon.apacheconf',
           regex: '\\b(?:Anonymous|Anonymous_Authoritative|Anonymous_LogEmail|Anonymous_MustGiveEmail|Anonymous_Nouid|Anonymous_VerifyEmail)\\b' },
