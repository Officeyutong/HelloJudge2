...
Revision ID: 6a38713e152d
Revises: 8bf4313c0b80
Create Date: 2020-01-23 14:03:20.339667
...
revision = '6a38713e152d'
down_revision = '8bf4313c0b80'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.alter_column('problems', 'using_file_io',
               ...
               type_=sa.Boolean(),
               existing_nullable=True)
    op.alter_column('remote_accounts', 'session',
               existing_type=mysql.VARCHAR(collation='utf8mb4_bin', length=256),
...
def downgrade():
    ...
    op.alter_column('remote_accounts', 'session',
               ...
               type_=mysql.VARCHAR(collation='utf8mb4_bin', length=256),
               existing_nullable=False)
    op.alter_column('problems', 'using_file_io',
               existing_type=sa.Boolean(),
               type_=mysql.TINYINT(display_width=1),
