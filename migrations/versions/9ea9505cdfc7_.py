...
Revision ID: 9ea9505cdfc7
Revises: 474011ad6fd4
Create Date: 2019-12-24 13:05:44.549275
...
revision = '9ea9505cdfc7'
down_revision = '474011ad6fd4'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.alter_column('submissions', 'language',
               existing_type=mysql.VARCHAR(collation='utf8mb4_bin', length=10),
...
def downgrade():
    ...
    op.alter_column('submissions', 'language',
               ...
               type_=mysql.VARCHAR(collation='utf8mb4_bin', length=10),
               existing_nullable=True)
    op.alter_column('problems', 'using_file_io',
               existing_type=sa.Boolean(),
               type_=mysql.TINYINT(display_width=1),
