...
Revision ID: de67784c5193
Revises: dddf329e86c0
Create Date: 2019-12-14 22:35:27.675761
...
revision = 'de67784c5193'
down_revision = 'dddf329e86c0'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.alter_column('discussions', 'top',
               ...
               type_=sa.Boolean(),
               existing_nullable=False)
    op.add_column('problems', sa.Column('remote_judge_oj', sa.String(length=10), nullable=True))
...
def downgrade():
    ...
    op.alter_column('problems', 'can_see_results',
               ...
               type_=mysql.TINYINT(display_width=1),
               existing_nullable=False)
    op.drop_column('problems', 'remote_problem_id')
    op.drop_column('problems', 'remote_judge_oj')
    op.alter_column('discussions', 'top',
               existing_type=sa.Boolean(),
               type_=mysql.TINYINT(display_width=1),
               existing_nullable=False)
