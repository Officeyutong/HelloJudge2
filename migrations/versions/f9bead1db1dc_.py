...
Revision ID: f9bead1db1dc
Revises: 5790fe124e67
Create Date: 2019-12-15 16:32:38.266494
...
revision = 'f9bead1db1dc'
down_revision = '5790fe124e67'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.alter_column('problems', 'using_file_io',
               ...
               type_=sa.Boolean(),
               existing_nullable=True)
    op.create_unique_constraint(None, 'remote_accounts', ['account_id'])
...
def downgrade():
    ...
    op.alter_column('submissions', 'public',
               ...
               type_=mysql.TINYINT(display_width=1),
               existing_nullable=True)
    op.drop_constraint(None, 'remote_accounts', type_='unique')
    op.alter_column('problems', 'using_file_io',
               existing_type=sa.Boolean(),
               type_=mysql.TINYINT(display_width=1),
               existing_nullable=True)
