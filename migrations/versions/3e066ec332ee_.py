...
Revision ID: 3e066ec332ee
Revises: de67784c5193
Create Date: 2019-12-15 15:46:04.817067
...
revision = '3e066ec332ee'
down_revision = 'de67784c5193'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.alter_column('problems', 'using_file_io',
               ...
               type_=sa.Boolean(),
               existing_nullable=True)
    op.add_column('remote_accounts', sa.Column('uid', sa.Integer(), nullable=False))
...
def downgrade():
    ...
    op.alter_column('submissions', 'public',
               ...
               type_=mysql.TINYINT(display_width=1),
               existing_nullable=True)
    op.drop_column('remote_accounts', 'uid')
    op.alter_column('problems', 'using_file_io',
               existing_type=sa.Boolean(),
               type_=mysql.TINYINT(display_width=1),
               existing_nullable=True)
